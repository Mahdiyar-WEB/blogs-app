  ...
  return (
    <div className="flex items-center gap-1.5 shrink-0 bg-secondary-100/80 border border-secondary-200 rounded-full p-1.5">
      <button
        ...
        className="w-9 h-9 rounded-full bg-white text-secondary-500 shadow-sm hover:bg-primary-700 hover:text-white flex items-center justify-center transition-colors duration-200"
      >
      ...
      <button
        ...
        className="w-9 h-9 rounded-full bg-white text-secondary-500 shadow-sm hover:bg-black hover:text-white flex items-center justify-center transition-colors duration-200"
      >
      ...
      <button
        onClick={copyLink}
        aria-label="کپی لینک"
        className="relative w-9 h-9 rounded-full bg-white text-secondary-500 shadow-sm hover:bg-secondary-600 hover:text-white flex items-center justify-center transition-colors duration-200"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-4 h-4">
