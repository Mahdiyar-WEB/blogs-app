  ...
  return (
    <article className="p-4 sm:p-8 lg:p-12">
      <div
        ref={contentRef}
        dir="rtl"
        className="article-content prose prose-secondary max-w-none 
                   /* ساختار ریسپانسیو هدینگ‌ها */
                   ...
                   prose-h5:text-sm sm:prose-h5:text-base lg:prose-h5:text-lg
                   prose-h6:text-xs sm:prose-h6:text-sm lg:prose-h6:text-base
                   
                   /* ساختار ریسپانسیو پاراگراف و متون بدنه */
                   prose-p:text-secondary-700 
                   prose-p:text-sm sm:prose-p:text-base lg:prose-p:text-lg 
                   prose-p:leading-7 sm:prose-p:leading-8 lg:prose-p:leading-9
                   
                   /* لینک‌ها و سایر اجزا */
                   prose-a:text-primary-600 prose-a:no-underline hover:prose-a:underline 
                   prose-strong:text-secondary-900 
                   prose-li:text-secondary-700 prose-li:text-sm sm:prose-li:text-base
                   prose-blockquote:border-primary-500 prose-blockquote:text-secondary-600 
                   prose-img:rounded-xl 
                   prose-hr:border-secondary-200 
                   prose-code:before:content-none prose-code:after:content-none 
                   
                   /* تنظیمات کدهای فرمت‌شده */
                   [&_pre]:overflow-x-auto [&_pre]:rounded-xl [&_pre]:text-left [&_pre]:dir-ltr [&_pre_code]:block"
