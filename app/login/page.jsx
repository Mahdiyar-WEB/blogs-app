      ...
      <div className="auth-tabs">
        <div className="flex rounded-xl gap-1">
          ...
          <button
            ...
            className={`auth-tab ${
              mode === "signup" ? "auth-tab--active" : "auth-tab--inactive"
            }`}
          >
            ثبت‌نام
          </button>
      ...
      <div className="px-7 pt-6 pb-8">
        ...
        <div className="mb-6">
          <h1 className="text-xl font-bold text-secondary-900">
            {mode === "login" ? "خوش برگشتی! 👋" : "حساب جدید بساز"}
          </h1>
          <p className="text-sm mt-1 text-secondary-400">
            {mode === "login"
              ? "با اطلاعات حسابت وارد شو"
              : "فقط یک دقیقه تا عضویت"}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="auth-submit relative mt-2"
            >
        ...
        <div className="grid grid-cols-2 gap-3">
          <button type="button" className="btn--outline btn flex items-center justify-center gap-2 py-2.5 text-sm font-medium text-secondary-600 bg-secondary-0 hover:bg-secondary-100 hover:border-secondary-400">
