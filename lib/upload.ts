...
import type { SavedUploadedFile } from "types/api";
...
export async function saveUploadedFile(
  ...
  fieldName: string,
  { maxSize }: SaveUploadedFileOptions = {},
): Promise<SavedUploadedFile | null> {
  ...
  return { filename, fileUploadPath: relativeDir, fileAddress };
}
